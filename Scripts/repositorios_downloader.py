    ...
    for repositorio in repositorios:
        ...
        try:
            if not os.path.exists(path_repo_baixado):
                ...
                print("\nVoce está baixando o repositório: " + nome_repositorio + " ele é o " + str(countRepositorionsBaixados) + "° repositório baixado.")
                time.sleep(2)
            ...
            log_downloads += "O repositório: " + nome_repositorio + " foi baixado (ou já estava baixado), ele é o repositorio de número: " + str(countRepositorionsBaixados) + ". Hora do término do download: " + now.strftime("%Y-%m-%d %H:%M:%S") + '\n\n'
            ...
            log_downloads += "O repositório: " + nome_repositorio + " foi pulado e não foi baixado, ele era o repositorio de número: " + str(countRepositorionsBaixados) + ". Hora do erro: " + now.strftime("%Y-%m-%d %H:%M:%S") + '\n\n'
        
        except:
            now = datetime.datetime.now()
            log_downloads += "O repositório: " + nome_repositorio + " apresentou problemas no download, ele era o repositório de número: " + str(countRepositorionsBaixados) + ". Hora do erro: " + now.strftime("%Y-%m-%d %H:%M:%S") + '\n\n'
